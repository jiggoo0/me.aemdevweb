...
export default async function BlogPostPage({
  ...
  return (
    <article className="min-h-screen bg-white pb-32">
      <header className="border-b border-slate-100 bg-slate-50 py-24">
        <Container>
          <Link
            href="/blog"
          ...
          <div className="max-w-4xl space-y-8">
            <h1 className="text-4xl leading-[0.95] font-black tracking-tighter text-slate-900 md:text-7xl">
              {post.title}
            </h1>
        ...
        <div className="grid grid-cols-1 gap-20 lg:grid-cols-12">
          ...
          <aside className="lg:col-span-4">
            <div className="sticky top-32 space-y-8">
              <div className="rounded-[3rem] border border-white/5 bg-slate-950 p-12 text-white shadow-2xl">
                <div className="mb-6 flex h-12 w-12 items-center justify-center rounded-2xl bg-blue-600">
                  <Share2 className="h-6 w-6" />
                </div>
                <h3 className="mb-4 text-2xl leading-tight font-black tracking-tight">
                ...
                <Link
                  href="/contact"
                  className="inline-flex h-14 w-full items-center justify-center rounded-2xl bg-blue-600 text-[11px] font-black tracking-[0.2em] uppercase transition-all hover:scale-[1.02] hover:bg-blue-500 active:scale-[0.98]"
                >
                  เริ่มโปรเจกต์ของคุณ
                </Link>
              </div>

              <div className="rounded-[3rem] border border-slate-100 bg-slate-50/50 p-10 text-center">
